    ...
    <div class="wrapper">
        ...
        <div id="element" class="hero-body-leave">
            ...
            <div class="alert alert-info">
                ...
                <a class="btn btn-success btn-large"  data-original-title="Add Employee?" href="emp_non_teaching_user.php">  <i class="icon-arrow-left icon-large"></i>&nbsp;Back</a>
                  </div>
            </div>
        ...
        <?php
            ...
            if (isset($_POST['save'])){
                ...
                header('location:emp_non_teaching_user.php');
