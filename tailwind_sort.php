        ...
        <div class="bg-white rounded-xl shadow-lg p-6 mb-8">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
                <div>
                    ...
                    <p class="text-gray-600 mt-1">Sort personnel by school</p>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                ...
                <div class="bg-gray-50 p-4 rounded-lg">
                    <form method="post" action="sort2.php" class="space-y-4">
                        <div>
            ...
            <div class="alert alert-info bg-blue-50 border border-blue-200 text-blue-700 p-4 rounded-lg mb-6">
                <h2 class="text-lg font-semibold"><?php echo $query_row['Name'] . ' Personnel Record'; ?></h2>
            </div>
            <?php } ?>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full bg-white rounded-lg overflow-hidden" id="log">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        ...
                        if (isset($_POST['filter'])){
                            $sort = $_POST['sort'];
                            $emp_query = mysqli_query($conn,"select * from employee where School='$sort'");
