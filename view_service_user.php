            ...
            <div class="container">
                <div class="marg">
                    <ul class="nav">
                        ...
                        <li><a href="leave_record_user.php"><i class="icon-list icon-large"></i>Leave Records</a></li>
...
<h2><font color=""><?php echo $get_row['FirstName']; ?>&nbsp;&nbsp;<?php echo $get_row['MiddleName']; ?>&nbsp;&nbsp;<?php echo $get_row['LastName']; ?>&nbsp; Service Record</font></h2>
    </div>


<div class="button-back">
<a class="btn  btn-large btn-success" href="emp_profiles_user.php"><i class="icon-arrow-left icon-large"></i>&nbsp;Back</a>
        <a href="service_view_user.php<?php echo '?id='.$get_id; ?>" class="btn  btn-large"><i class="icon-print icon-large"></i>&nbsp;Print Preview</a>
</div>
<hr>
