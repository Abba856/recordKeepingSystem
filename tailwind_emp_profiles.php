    ...
    <div class="container mx-auto px-4 py-8">
        <div class="bg-white rounded-xl shadow-lg p-6 mb-8">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
                <div>
                    <h1 class="text-2xl font-bold text-gray-800 flex items-center">
                        <i class="fas fa-users text-blue-500 mr-3"></i> Personnel List
                    </h1>
                    <p class="text-gray-600 mt-1">Manage and view all personnel records</p>
                </div>
                
                <div class="mt-4 md:mt-0 flex flex-wrap gap-2">
                    <a href="emp_add.php" class="flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors duration-200 shadow-md">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <form method="post" action="sort.php" class="bg-gray-50 p-4 rounded-lg">
                    <label class="block text-sm font-medium text-gray-700 mb-2">Sort by School</label>
                    <div class="flex">
                        <select name="sort" class="flex-1 px-3 py-2 border border-gray-300 rounded-l-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                        ...
                        <button name="filter" class="px-4 py-2 bg-green-600 text-white rounded-r-lg hover:bg-green-700 transition-colors duration-200">
                            <i class="fas fa-filter"></i>
                        </button>
                    </div>
                </form>
                
                <form method="post" action="sort1.php" class="bg-gray-50 p-4 rounded-lg">
                    <label class="block text-sm font-medium text-gray-700 mb-2">Sort by Position</label>
                    <div class="flex">
                        <select name="position" class="flex-1 px-3 py-2 border border-gray-300 rounded-l-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                        ...
                        <button name="filter1" class="px-4 py-2 bg-green-600 text-white rounded-r-lg hover:bg-green-700 transition-colors duration-200">
                            <i class="fas fa-filter"></i>
                        </button>
                    </div>
                </form>
                
                <form method="post" action="sort2.php" class="bg-gray-50 p-4 rounded-lg">
                    <label class="block text-sm font-medium text-gray-700 mb-2">Sort by Qualification</label>
                    <div class="flex">
                        <select name="qualification" class="flex-1 px-3 py-2 border border-gray-300 rounded-l-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                        ...
                        <button name="filter2" class="px-4 py-2 bg-green-600 text-white rounded-r-lg hover:bg-green-700 transition-colors duration-200">
                            <i class="fas fa-filter"></i>
                        </button>
                    </div>
                </form>
            ...
            <div class="flex border-b border-gray-200 mb-6">
                <a href="emp_profiles.php" class="py-2 px-4 font-medium text-blue-600 border-b-2 border-blue-600">Teaching</a>
                <a href="emp_non_teaching.php" class="py-2 px-4 font-medium text-gray-500 hover:text-gray-700">Non-Teaching</a>
            </div>
                ...
                <table class="min-w-full bg-white rounded-lg overflow-hidden" id="log">
                    <thead class="bg-gray-100">
                        <tr>
                            ...
                            <th class="py-3 px-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Middle Name</th>
