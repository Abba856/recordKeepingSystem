            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
                <div>
                    <h1 class="text-2xl font-bold text-gray-800 flex items-center">
                        <i class="fas fa-calendar-check text-blue-500 mr-3"></i> <?php echo $get_row['FirstName']; ?>&nbsp;&nbsp;<?php echo $get_row['MiddleName']; ?>&nbsp;&nbsp;<?php echo $get_row['LastName']; ?> Service Credits
                    </h1>
                    <p class="text-gray-600 mt-1">View and manage service credits</p>
                </div>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full bg-white rounded-lg overflow-hidden" id="log">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        <?php 
                        $emp_query = mysqli_query($conn,"select * from leave_record where employeeID='$get_id'");
