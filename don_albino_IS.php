        ...
        <div id="element" class="hero-body">
            <div class="left-nav">
                ...
                <ul class="nav nav-tabs nav-stacked">
                    ...
                    <li class="active"><a href="don_albino_IS.php">Don Albino & Do�a Dolores Jison Integrated School</a></li>
            ...
            <div class="right-nav-content">
                <div class="alert alert-info">
                    <h2>Don Albino & Do�a Dolores Jison Integrated School Employee List</h2>
                </div>
                ...
                <?php $emp_query=mysqli_query($conn,"select * from employee where School='Don Albino & Do�a Dolores Jison IS'");
