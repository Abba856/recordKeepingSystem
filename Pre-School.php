        ...
        <div id="element" class="hero-body">
            <div class="left-nav">
                ...
                <ul class="nav nav-tabs nav-stacked">
                    ...
                    <li class="active"><a href="Pre-School.php">Division of Silay Pre-School</a></li>
                    <li><a href="elem_school.php"><font color="white">Elementary School</font></a></li>
                </ul>
            </div>
            <div class="right-nav-content">
                <div class="alert alert-info">
                    <h2>Division of Silay Pre-School Employee List</h2>
                </div>
                ...
                <?php $emp_query=mysqli_query($conn,"select * from employee where School='Division of Silay Pre-School'");
