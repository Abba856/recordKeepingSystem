        ...
        <div class="bg-white rounded-xl shadow-lg p-6 mb-8">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
                <div>
                    ...
                    <p class="text-gray-600 mt-1">Manage non-teaching personnel records</p>
                </div>
            ...
            <div class="flex border-b border-gray-200 mb-6">
                <a href="emp_profiles.php" class="py-2 px-4 font-medium text-gray-500 hover:text-gray-700">Teaching</a>
                <a href="emp_non_teaching.php" class="py-2 px-4 font-medium text-blue-600 border-b-2 border-blue-600">Non-Teaching</a>
            </div>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full bg-white rounded-lg overflow-hidden" id="log">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        <?php 
                        $emp_query = mysqli_query($conn,"select * from employee where Classification='Non-Teaching'");
                        ...
                        <tr class="hover:bg-gray-50 del<?php echo $id ?>">
                            ...
                            <td class="py-3 px-4 text-sm space-x-2">
                                ...
                                <?php include('button_view_non.php'); ?>
                                ...
                                <?php include('button_add_non.php'); ?>
                            </td>
                        </tr>
                        <?php }?>
                    </tbody>
