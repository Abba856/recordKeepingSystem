    ...
    <div class="container mx-auto px-4 py-1">
        <div class="bg-white rounded-xl shadow-lg p-6 mb-8">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
                <div>
                    <h1 class="text-2xl font-bold text-gray-800 flex items-center">
                        <i class="fas fa-file-alt text-blue-500 mr-3"></i> Service Credits
                    </h1>
                    <p class="text-gray-600 mt-1">View all service credits</p>
                </div>
                
                <div class="mt-4 md:mt-0 flex flex-wrap gap-2">
                    <a href="leave_preview.php" class="flex items-center px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors duration-200">
            ...
            <div class="flex flex-col md:flex-row md:items-center gap-4 mb-6 p-4 bg-gray-50 rounded-lg">
                <form method="POST" action="sort_leave.php" class="flex flex-col md:flex-row gap-2">
