...
<body>
 <?php include('nav-top.php'); ?>
            ...
            <div class="container">
                <div class="marg">
                    <ul class="nav">
                        ...
                        <li><a href="emp_profiles_user.php"><i class="icon-group icon-large"></i>Staff</a></li>
                        ...
                        <form  method="POST" action="search_user.php" class="navbar-search pull-right">
                            <input type="text" name="search" class="search-query" value="<?php echo isset($_POST['search']) ? $_POST['search'] : '' ?>" placeholder="Search">
                        </form>
    ...
    <div id="element" class="hero-body">
        ...
        <form method="post" action="sort_user.php">
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="display" id="log" class="jtable">
             ...
             $search=$_POST['search'];    
              ?>  
                    ...
                    <?php $emp_query=mysqli_query($conn,"select * from employee where FirstName like '%$search%' or LastName like '%$search%' or MiddleName like '%$search%' or employeeID like '%$search%'");
