            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
                <div>
                    <h1 class="text-2xl font-bold text-gray-800 flex items-center">
                        <i class="fas fa-briefcase text-blue-500 mr-3"></i> Add Service Record to <?php echo $row['FirstName']." ".$row['LastName']; ?>
                    </h1>
                    <p class="text-gray-600 mt-1">Record service information</p>
                </div>
            ...
            <div class="max-w-3xl mx-auto">
                <form method="post" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Station/Place</label>
                            <input 
                                type="text" 
                                name="Station" 
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                placeholder="Enter station/place"
                            >
                        </div>
                    ...
                    <div class="pt-4">
                        ...
                        >
                            <i class="fas fa-save mr-2"></i> Save Service Record
                        </button>
                    </div>
                </form>
            </div>
