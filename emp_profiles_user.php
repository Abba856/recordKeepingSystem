...
<body>
            ...
            <div class="container">
                <div class="marg">
                    <ul class="nav">
                        ...
                        <li class="active"><a href="emp_profiles_user.php"><i class="icon-group icon-large"></i>Staff</a></li>
    ...
    <div id="element" class="hero-body-emp">
        ...
        <div class="pull-right">  
            ...
            <ul>
                <li  class="active"><a href="emp_profiles_user.php" id="color_white">Teaching</a></li>

                <li><a href="emp_non_teaching_user.php" id="color_white">Non-Teaching</a></li>
            </ul>
        ...
        <div class="demo_jui">
            <table cellpadding="0" cellspacing="0" border="0" class="display" id="log" class="jtable">
                ...
                <tbody>
                    ...
                    <?php $emp_query=mysqli_query($conn,"select * from employee where Classification='Teaching'");
