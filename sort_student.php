...
<body>
    ...
    <div id="element" class="hero-body-emp">
        ...
        <div class="alert alert-info">
            <h2><i class="icon-filter icon-large"></i> Students in <?php echo $grade_level; ?></h2>
        </div>
        <?php } else { ?>
        <div class="alert alert-info">
            <h2><i class="icon-filter icon-large"></i> Student Sorting</h2>
        </div>
        <?php } ?>
        ...
        <div class="card shadow">
            <div class="card-body">
                <table class="display" id="sorted-students-table">
                    <thead>
                        <tr>
                            <th>Student No</th>
                            <th>FirstName</th>
