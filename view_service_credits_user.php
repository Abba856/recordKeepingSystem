   ...
   <?php include('nav-top.php'); ?>
    ...
    <div id="element" class="hero-body">
        ...
        <div class="button-back">
            <a class="btn  btn-large btn-success" href="emp_non_teaching_user.php"><i class="icon-arrow-left icon-large"></i>&nbsp;Back</a>
            <a href="print_service_credits_user.php<?php echo '?id='.$member_id; ?>" class="btn  btn-large"><i class="icon-print icon-large"></i>&nbsp;Print Preview</a>
        </div>
        <hr>
