...
<body>
    ...
    <div id="element" class="hero-body-emp">
        ...
        <div class="pull-right">  
            ...
            <ul>
                <li><a href="emp_profiles_user.php" id="color_white">Teaching</a></li>

                <li class="active"><a href="emp_non_teaching_user.php" id="color_white">Non-Teaching</a></li>
            </ul>
