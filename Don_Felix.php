        ...
        <div id="element" class="hero-body">
            <div class="left-nav">
                ...
                <ul class="nav nav-tabs nav-stacked">
                    ...
                    <li class="active"><a href="Don_Felix.php">Don Felix T. Lacson Memorial National High School</a></li>
            ...
            <div class="right-nav-content">
                <div class="alert alert-info">
                    <h2>Don Felix T. Lacson Memorial National High School School Employee List</h2>
                </div>
                ...
                <?php $emp_query=mysqli_query($conn,"select * from employee where School='Don Felix T. Lacson Memorial NHS'");
