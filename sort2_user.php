   ...
   <?php include('nav-top.php'); ?>
    ...
    <div id="element" class="hero-body">
            ...
            <h2>
                <?php
                    if(isset($_POST['filter2'])){
                        ...
                        echo $query_row['qualification']." ".'Degree List';
        ...
        <div class="pull-right">  
			...
			<form method="POST" action="print_list2_user.php">
            <button type="submit" name="print" class="btn btn-large"><i class="icon-user icon-large"></i>&nbsp;Print List</a></button>
			<input type="hidden" name="print_qualification" value="<?php echo $qualification;  ?>">
			</form>
            <br>
            <br>
