        ...
        <div id="element" class="hero-body">
            <div class="left-nav">
                ...
                <ul class="nav nav-tabs nav-stacked">
                    ...
                    <li class="active"><a href="Lantawan.php">Lantawan Integrated School</a></li>
            ...
            <div class="right-nav-content">
                <div class="alert alert-info">
                    <h2>Lantawan Integrated School Employee List</h2>
                </div>
                ...
                <?php $emp_query=mysqli_query($conn,"select * from employee where School='Lantawan Integrated School'");
