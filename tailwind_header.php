...
<head>
    ...
    <link href="css/clean-modern-style.css" rel="stylesheet" type="text/css" media="screen">
    <link href="css/modern-styles.css" rel="stylesheet" type="text/css" media="screen">
    <!-- Tailwind CSS -->
